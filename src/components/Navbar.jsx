...
export default function Navbar({
  ...
  return (
    <nav className="fixed w-full z-50 bg-gray-900/96 border-b border-gray-800 md:backdrop-blur-md">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-3">
            <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg flex items-center justify-center">
              <img className="h-4 w-4 sm:h-6 sm:w-6 text-white" src={icon} />
            </div>
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            {/* Desktop CTA - Using CSS for hover effects */}
            <button
              onClick={downloadCV}
              className="flex items-center px-3 py-2 sm:px-4 sm:py-2 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-lg hover:from-blue-600 hover:to-purple-600 transition-all duration-200 hover:scale-105 active:scale-95 shadow-md text-sm sm:text-base cursor-pointer transform-gpu"
            >
